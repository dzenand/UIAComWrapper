...
{
    public class GridPattern : BasePattern<UIAutomationClient.IUIAutomationGridPattern>
    {
    ...
    public class GridItemPattern : BasePattern<UIAutomationClient.IUIAutomationGridItemPattern>
    {
